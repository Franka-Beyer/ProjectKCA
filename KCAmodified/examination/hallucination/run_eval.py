...
def main(args):
    ...
    subjects = sorted(
        [
            ...
            for f in os.listdir(args.data_dir) #trying to fix bug
            if "_test.jsonl" in f
        ]
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_dir",
        type=str,
        default="./data/examination/input/train/"
    )
    parser.add_argument(
        "--save_dir",
        type=str,
        #default="./data/examination/output/test_truth_2/tinyLLM/5-shot/"
        default="./data/examination/output/train/qwen2-1.5b/5-shot/"
    )
    parser.add_argument(
        "--model_name_or_path",
        type=str,
        #default="Tiny-LLM-llama",
        default=None,
