                ...
                for testset in ["lima_testset"]:
                    for trainset in ["wizardlm_trainset"]:
                        for judge_type in ["hallucination_judge", "effectiveness_judge"]:
                            ...
                            global_path = os.path.expanduser("~/Downloads/Projekt/KCA/evaluation_results/review_greedy")
